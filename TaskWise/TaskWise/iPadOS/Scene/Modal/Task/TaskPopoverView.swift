...
struct TaskPopoverView {
    private typealias Txt = Str.Task

    @Environment(\.dismiss) var dismiss
    @Bindable var viewModel: TaskPopoverViewModel
    ...
    init(
        ...
        self.viewModel = TaskPopoverViewModel(dataService: dataService, task: task, priorities: priorities, categories: categories, columns: columns)
    }
}

extension TaskPopoverView: View {
    var body: some View {
        ScrollView {
